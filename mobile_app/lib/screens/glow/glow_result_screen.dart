...
class _GlowResultScreenState extends State<GlowResultScreen> {
          ...
          child: ClipRRect(
            ...
            child: Stack(
              ...
              children: [
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(LucideIcons.chevronLeft, size: 10, color: AppColors.bg),
                              Icon(LucideIcons.chevronRight, size: 10, color: AppColors.bg),
                            ],
                          ),
                        ),
                        Expanded(child: Container(width: 2, color: Colors.white.withValues(alpha: 0.8))),
                ...
                Positioned(
                  bottom: 12, left: 12,
                  child: _label('Before', AppColors.textSec),
                ),
                Positioned(
                  bottom: 12, right: 12,
                  child: _label('After', AppColors.brand),
                ),
              ],
            ),
          ),
  ...
  Widget _buildImageLayer({required bool isAfter}) {
    if (isAfter) {
      ...
      final originalFile = widget.isLocalFilter ? widget.originalPath : widget.imagePath;
      if (originalFile != null) {
        return Image.file(File(originalFile), fit: BoxFit.cover);
      }
      return PlaceholderImage(
  ...
  Widget _buildDetailsGrid() {
    ...
    if (widget.isLocalFilter) {
      ...
      final filter = modeFilters.firstWhere((f) => f.id == widget.filterId, orElse: () => modeFilters.first);
      items = [
        ('Mode', LucideIcons.layers, mode.name),
        ('Filter', LucideIcons.palette, filter.name),
        ('Type', LucideIcons.sparkles, 'AI Enhanced'),
        ('Quality', LucideIcons.eye, 'HD'),
      ];
    }
          ...
          GridView.count(
            ...
            children: items.map((item) {
              return Container(
                ...
                child: Row(children: [
                  Icon(item.$2, size: AppSizes.iconMd, color: AppColors.brand),
  ...
  Widget _buildSecondaryActions() {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          _toolBtn(LucideIcons.camera, 'Camera', () => context.go('/glow')),
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Row(children: [
            ...
            Icon(LucideIcons.chevronRight, size: AppSizes.iconMd, color: AppColors.brand),
          ]),
        ),
        ),
      ),
